          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 flex flex-col">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Enhance your logical reasoning and quantitative aptitude skills with our targeted
                modules.
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 flex flex-col">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Learn effective communication strategies for group discussions and team
                collaborations.
              </p>
              <button className="mt-auto text-white bg-blue-600 hover:bg-blue-700 py-2 px-4 rounded text-sm">
                Start Module
